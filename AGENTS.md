...
This project is indexed by GitNexus as **slisic** (7250 symbols, 16855 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
