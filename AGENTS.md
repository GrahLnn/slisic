...
This project is indexed by GitNexus as **tauri-react** (4455 symbols, 9598 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
