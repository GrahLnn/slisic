...
This project is indexed by GitNexus as **ransic** (2584 symbols, 5805 relationships, 210 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
