...
This project is indexed by GitNexus as **slisic** (7535 symbols, 17607 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
