...
This project is indexed by GitNexus as **slisic** (6597 symbols, 15084 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
