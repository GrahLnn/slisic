...
This project is indexed by GitNexus as **slisic** (6953 symbols, 16037 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
