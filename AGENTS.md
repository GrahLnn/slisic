...
This project is indexed by GitNexus as **ransic** (1251 symbols, 3373 relationships, 102 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/ransic/process/{processName}` — trace the full execution flow step by step
