...
This project is indexed by GitNexus as **tauri-react** (4719 symbols, 10203 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
