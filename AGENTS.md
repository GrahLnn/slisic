...
This project is indexed by GitNexus as **slisic** (7176 symbols, 16640 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
