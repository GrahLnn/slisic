...
This project is indexed by GitNexus as **slisic** (7452 symbols, 17419 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
