...
This project is indexed by GitNexus as **tauri-react** (5604 symbols, 12462 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
