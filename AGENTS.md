...
This project is indexed by GitNexus as **slisic** (7689 symbols, 17959 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
