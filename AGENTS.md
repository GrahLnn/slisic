...
This project is indexed by GitNexus as **ransic** (3365 symbols, 7434 relationships, 289 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
