...
This project is indexed by GitNexus as **tauri-react** (3558 symbols, 7826 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
