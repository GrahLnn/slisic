...
This project is indexed by GitNexus as **slisic** (6697 symbols, 15305 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
