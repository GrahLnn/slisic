...
This project is indexed by GitNexus as **tauri-react** (3561 symbols, 7827 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
