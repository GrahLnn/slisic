...
This project is indexed by GitNexus as **tauri-react** (4958 symbols, 10918 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
