...
This project is indexed by GitNexus as **tauri-react** (5101 symbols, 11159 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
