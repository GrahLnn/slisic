...
This project is indexed by GitNexus as **slisic** (7173 symbols, 16634 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
