...
This project is indexed by GitNexus as **tauri-react** (6089 symbols, 13749 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
