...
This project is indexed by GitNexus as **tauri-react** (5068 symbols, 10989 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
